...
{ Complex }
 ...
 Complex = record
    re : real;
    im : real;
    class operator := (r : real) z : complex;  inline;
    class operator + (z1, z2 : complex) z : complex; inline;
    class operator + (z1 : complex; r : real) z : complex; inline;
    class operator + (r : real; z1 : complex) z : complex; inline;
    class operator - (z1, z2 : complex) z : complex; inline;
    class operator - (z1 : complex;r : real) z : complex; inline;
    class operator - (r : real; z1 : complex) z : complex; inline;
    class operator * (z1, z2 : complex) z : complex; inline;
    class operator * (z1 : complex; r : real) z : complex; inline;
    class operator * (r : real; z1 : complex) z : complex; inline;
    class operator / (znum, zden : complex) z : complex; inline;
    class operator / (znum : complex; r : real) z : complex; inline;
    class operator / (r : real; zden : complex) z : complex; inline;
    class operator ** (z1, z2 : complex) z : complex;
    class operator ** (z1 : complex; r : real) z : complex;
    class operator ** (r : real; z1 : complex) z : complex;
    class operator = (z1, z2 : complex) b : boolean;
    class operator = (z1 : complex;r : real) b : boolean;
    class operator = (r : real; z1 : complex) b : boolean;
    class operator - (z1 : complex) z : complex; inline;
 end;
...
const
  ...
  class operator Complex.:= (r : real) z : complex; inline;
    begin
       z.re:=r;
       z.im:=0.0;
    end;
  ...
  class operator Complex.+ (z1, z2 : complex) z : complex; inline;
    { addition : z := z1 + z2 }
    begin
       z.re := z1.re + z2.re;
       z.im := z1.im + z2.im;
  ...
  class operator Complex.+ (z1 : complex; r : real) z : complex; inline;
  { addition : z := z1 + r }
    begin
       z.re := z1.re + r;
       z.im := z1.im;
  ...
  class operator Complex.+ (r : real; z1 : complex) z : complex; inline;
  { addition : z := r + z1 }
   begin
       z.re := z1.re + r;
       z.im := z1.im;
  ...
  class operator Complex.- (z1 : complex) z : complex; inline;
   { substraction : z := - z1 }
    begin
       z.re := -z1.re;
       z.im := -z1.im;
 ...
 class operator Complex.- (r : real; z1 : complex) z : complex; inline;
  ...
  class operator Complex./ (znum, zden : complex) z : complex; inline;
  ...
  class operator Complex./ (znum : complex; r : real) z : complex;
      { division : z := znum / r }
      begin
         z.re := znum.re / r;
         z.im := znum.im / r;
  ...
  class operator Complex./ (r : real; zden : complex) z : complex;
    { division : z := r / zden }
    var denom : real;
    begin
  ...
  class operator Complex.= (z1, z2 : complex) b : boolean;
    { returns TRUE if z1 = z2 }
    begin
       b := (z1.re = z2.re) and (z1.im = z2.im);
    end;

  class operator Complex.= (z1 : complex; r :real) b : boolean;
    { returns TRUE if z1 = r }
    begin
       b := (z1.re = r) and (z1.im = 0.0)
    end;

  class operator Complex.= (r : real; z1 : complex) b : boolean;
    { returns TRUE if z1 = r }
    begin
       b := (z1.re = r) and (z1.im = 0.0)
    end;
  ...
  class operator Complex.** (z1, z2 : complex) z : complex;
    { exp : z := z1 ** z2 }
    begin
       z := cexp(z2*cln(z1));
    end;

  class operator Complex.** (z1 : complex; r : real) z : complex;
    { multiplication : z := z1 * r }
    begin
       z := cexp( r *cln(z1));
    end;

  class operator Complex.** (r : real; z1 : complex) z : complex;
    { multiplication : z := r + z1 }
    begin
       z := cexp(z1*ln(r));
    end;
  ...
  function carg_ch (z : complex) : complex;
    ...
    begin
       carg_ch:=-cln(z+_i*csqrt(1.0-z*z));
    end;
